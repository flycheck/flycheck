...
(ert-deftest checker-puppet-parser-first-syntax-error ()
  "Test a real syntax error with puppet parser."
  :expected-result (flycheck-testsuite-fail-unless-checker 'puppet-parser)
  (flycheck-testsuite-should-syntax-check
   "checkers/puppet/parser/parser_err1.pp" 'puppet-mode nil
   '(3 nil "Syntax error at ','; expected '}'" error)))

(ert-deftest checker-puppet-parser-second-syntax-error ()
  "Test another real syntax error with puppet parser."
  :expected-result (flycheck-testsuite-fail-unless-checker 'puppet-parser)
  (flycheck-testsuite-should-syntax-check
   "checkers/puppet/parser/parser_err2.pp" 'puppet-mode nil
   '(5 nil "Syntax error at end of file; expected '}'" error)))

(ert-deftest checker-puppet-parser-multiline-syntax-error ()
  "Test a real (multi line) syntax with puppet parser."
  :expected-result (flycheck-testsuite-fail-unless-checker 'puppet-parser)
  (flycheck-testsuite-should-syntax-check
   "checkers/puppet/parser/parser_err3.pp" 'puppet-mode nil
