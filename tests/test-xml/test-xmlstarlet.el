...
(ert-deftest xmlstarlet-lone-closing-tag ()
  ...
  (should-flycheck-checker
   (resource "lone-closing-tag.xml") 'nxml-mode 'xml-xmlstarlet
...
(ert-deftest xmlstarlet-undefined-entity ()
  ...
  (should-flycheck-checker
   (resource "undefined-entity.xml") 'nxml-mode 'xml-xmlstarlet
