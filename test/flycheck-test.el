;;; flycheck-test.el --- Testsuite for Flycheck -*- lexical-binding: t; -*-
...
;; Unit tests for Flycheck.

;; Keep these tests in order of declaration of the corresponding
;; function/variable/checker in flycheck.el
