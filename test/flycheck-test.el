...
(flycheck-ert-def-checker-test proselint (text markdown) nil
  (flycheck-ert-should-syntax-check
   "language/text.txt" 'txt-mode
   '(1 5 warning "Substitute 'damn' every time you're inclined to write 'very;' your editor will delete it and the writing will be just as it should be."
