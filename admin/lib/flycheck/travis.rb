...
module Flycheck
  ...
  module Travis
    ...
    def skip_unless_environment(variable, value, message)
    ...
    def clone_and_configure_repo(target_directory)
    ...
    def configure_ssh_for_github(key)
...
EOF
    ...
    def decrypt_deployment_key(source, target)
    ...
    def do_deploy_manual(directory)
